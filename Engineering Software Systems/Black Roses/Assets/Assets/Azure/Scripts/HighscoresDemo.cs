...
public class HighscoresDemo : MonoBehaviour, ITableViewDataSource
{
	...
	{
		var orderBy = new OrderBy("scoreString", SortDirection.asc);
	...
	private Highscore GetScore ()
	{
        ...
        /*string*/string score = GameObject.Find("Timer").GetComponent<PlayerTimer>().getHighscoreAsString();// GameObject.Find ("InputScore").GetComponent<InputField> ().text;
        float scoreString = GameObject.Find("Timer").GetComponent<PlayerTimer>().getHighScoreAsFloat();
		...
		if (/*!String.IsNullOrEmpty (*/scoreString >0/*)*/) {
            ...
            highscore.scoreString = scoreString;
		}
	...
	private void DisplayScore (Highscore highscore)
	{
        ...
        score.text = highscore.score;// String;
